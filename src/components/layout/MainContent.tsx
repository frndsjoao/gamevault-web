    ...
    return (
      <header className="flex flex-shrink-0 flex-row items-center justify-between border-b-2 border-bg-dark bg-transparent px-3 py-3 md:px-4 md:py-3.5 lg:px-6 lg:py-4">
        <div className="flex flex-row items-center gap-2 max-lg:space-x-2 md:gap-2.5 lg:gap-0">
          ...
          <h1 className="truncate text-base font-bold text-text-light md:text-lg lg:text-xl">
        ...
        <button
          ...
          className="flex flex-row items-center gap-2 rounded-lg px-2.5 py-1.5 transition-colors duration-200 hover:bg-gray-900 active:scale-95 md:gap-3 md:px-3 md:py-2 lg:px-4"
        >
          <Icon name="search" size={16} className="text-text-light" />
          <span className="text-xs text-text-light max-md:hidden md:text-sm">
            Search game
          </span>
        </button>
      </header>
